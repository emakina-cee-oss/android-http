...
public class HttpServiceAssister {
     ...
     *
     * @param context a {@link Context} object.
     * @param factory the factory used to construct a configuration for
     ...
     *
     * @param callback         the {@link Handler.Callback} that will be informed once the
     *                         {@link WebRequest} has been completed
     * @param webRequest       the {@link WebRequest} to run
     * @param serviceProcessor the {@link ServiceProcessor} that should be used to process
     *                         the {@link WebRequest}
     */
     ...
     *
     * @param wr the {@link WebRequest} to queue
     */
     ...
     *
     * @param webRequest       the {@link WebRequest} to run
     * @param serviceProcessor the processor that handles the {@link WebRequest}
     ...
     *
     * @param serviceProcessor the {@link ServiceProcessor} used for the {@link WebRequest}
     */
     ...
     *
     * @param standardServiceConnection the connection to use
     */
    ...
    public class HttpServiceAssisterConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            if (!(service instanceof HttpServiceBinder)) {
                throw new IllegalArgumentException("Binder must be of type HttpServiceBinder but is: " + service);
            }
     ...
     *
     * @param nonTimeCriticalTaskProcessingListener a listener that receives updates when a task has been started.
     ...
     * when the listener is no longer needed!
     *
     * @param nonTimeCriticalTaskProcessingListener the listener
     */
