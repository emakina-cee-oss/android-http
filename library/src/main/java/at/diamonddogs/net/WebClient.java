...
public abstract class WebClient implements Callable<ReplyAdapter> {
    ...
    protected WebReply handleResponseOk(InputStream i, int statusCode, Map<String, List<String>> replyHeader) throws
			IOException {
    ...
    protected ReplyAdapter createListenerReply(WebRequest request, WebReply reply, Throwable throwable, Status
			replyStatus) {
